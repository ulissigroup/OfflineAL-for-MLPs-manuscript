...
if __name__ == "__main__":
    ...
    n = int(batch.split("_")[0])
    s = int(batch.split("_")[1])

    wdir = f"al_relax_{batch}/trial_{trial}"
    ...
    training_params = {
        "al_convergence": {"method": "iter", "num_iterations": n},
        "samples_to_retrain": s,
        "Gs": Gs,
        "morse": True,
        "forcetraining": True,
        "cores": 3,
        ...
        "shuffle": False,
        "verbose": 1,
        "filename": f"al_batch_trial_{trial}",
        "file_dir": f"./",
